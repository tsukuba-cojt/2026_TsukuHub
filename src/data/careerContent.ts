...
export const basicTopics = [
  ["就活全体の進め方", "準備から内定までの流れと、今やることを整理します。"],
  ["長期インターンとは", "アルバイトとの違い、探し方、参加前の確認事項を学びます。"],
  ["自己分析", "経験を振り返り、価値観や強みを言葉にします。"],
  ["業界・企業研究", "情報を集め、企業ごとの違いを比較する方法を紹介します。"],
  ["エントリーシート", "読み手に伝わる構成と推敲のポイントを確認します。"],
  ["面接対策", "よくある質問への準備と、対話の基本を学びます。"],
  ["Webテスト", "形式を知り、無理なく練習を進める方法をまとめます。"],
  ["就活スケジュール管理", "授業・研究と両立する計画の立て方を紹介します。"],
] as const;
