...
const categories = [
  {
    imageSrc: "/src/assets/home/CategoryCard/Bag.svg",
    title: "就活・キャリア",
    text: "インターン・就職活動や\nキャリア支援をまとめて確認",
    path: "/career",
  ...
  {
    imageSrc: "/src/assets/home/CategoryCard/Eat.svg",
    title: "生活・便利情報",
    text: "学食・住まい・交通など\nキャンパスライフに役立つ情報",
    path: "/lifestyle",
  ...
  {
    imageSrc: "/src/assets/home/CategoryCard/Calendar.svg",
    title: "イベント・お知らせ",
    text: "学内イベントや学校からの\n最新情報をチェック",
    path: "/events",
  ...
  {
    imageSrc: "/src/assets/home/CategoryCard/Network.svg",
    title: "留学・国際交流",
    text: "留学プログラムや\n国際交流の情報を掲載",
    path: "/global",
